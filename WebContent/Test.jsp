...
<body>
	...
	<div class="testPageContent">
		...
		<form action="TestServlet" method="get" name="youPickItForm">
			<select id="comboboxTest" name="suite" size="5" multiple>
				<option value="silverApples.junit.ics.TestCustomer">
					TestCustomer</option>
				<option value="silverApples.junit.ics.TestEvent">TestEvent</option>
				<option value="silverApples.junit.ics.TestAttending">
					TestAttending</option>
				<option value="silverApples.junit.ics.AllTests">AllTests</option>
